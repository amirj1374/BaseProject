import type { CustomerDto, FacilitiesRequest, Facility, GreenLicense, Guarantee, GuaranteeRequest, GuarantorDto, Lc, LcRequest, LoanRequestDetail, SummaryDto } from '@/types/approval/approvalType'
