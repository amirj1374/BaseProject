...
// });
const header = ref([
  { title: 'نوع ارز', key: 'currencyCode', sortable: true, editable: false, type: 'string' },
  { title: 'نوع تسهیلات', key: 'loanContractTypeTitle', sortable: true, editable: false, type: 'string' },
  ...
  {
    title: ' اصل - مانده استفاده شدهی جاری حد سالانه',
    key: 'annualLimitCurrentPrincipalRemain',
    sortable: true,
    editable: true,
    type: 'money'
  },
  {
    title: 'سود - مانده استفاده شدهی جاری حد سالانه',
    key: 'annualLimitCurrentInterestRemain',
    sortable: true,
    editable: true,
    type: 'money'
  },
...
<template>
  <v-btn size="large" @click="isDialogActive = true"> سوابق تسهیلات ریالی </v-btn>
    ...
    <v-card title="سوابق تسهیلات ریالی">
      <v-card-text>
        <v-row>
          <v-col cols="12" md="12">
            <CustomDataTable
              :apiResource="`back/api/v1/loan-info`"
