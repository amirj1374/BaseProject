  ...
  <div class="approval-section">
    <v-form ref="formRef" v-model="isValid" lazy-validation>
      ...
      <v-row>
        ...
        <v-col cols="12" md="3">
          <v-text-field v-model.number="form.operatingProfit" type="number" label="سود عملیاتی" variant="outlined" density="comfortable" />
        </v-col>
        <v-col cols="12" md="3">
          <v-text-field v-model.number="form.netProfit" type="number" label="سود (زیان) خالص" variant="outlined" density="comfortable" />
        </v-col>
        <v-col cols="12" md="3">
          <v-text-field
      ...
      <v-row>
        ...
        <v-col cols="12" md="3" class="d-flex align-center">
          <v-switch v-model="form.hasReturnedChecks" inset color="primary" hide-details class="me-2" />
