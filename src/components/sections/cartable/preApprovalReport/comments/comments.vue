<template>
  <div class="comments">
    ...
    <div class="content">
      <p>محتوای ساير شرايط و ملاحظات</p>
    </div>
  </div>
</template>
...
console.log('Comments component received props:', props);

// Submit data method for stepper
const submitData = async () => {
  try {
    // Add your validation and submission logic here
    console.log('Submitting comments data for loan request:', props.loanRequestId);
